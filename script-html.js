...
<div class="container">
    <div class="key_line">
        ...
        <button class="button" data-name="Digit4">4</button>
        <button class="button" data-name="Digit5">5</button>
        <button class="button" data-name="Digit6">6</button>
        <button class="button" data-name="Digit7">7</button>
        <button class="button" data-name="Digit8">8</button>
        <button class="button" data-name="Digit9">9</button>
        <button class="button" data-name="Digit0">0</button>
        <button class="button" data-name="NumpadSubtract">-</button>
        ...
        <button class="button" data-name="MetaLeft" data-spec="true">Win</button>
        <button class="button" data-name="AltLeft" data-spec="true">Alt</button>
